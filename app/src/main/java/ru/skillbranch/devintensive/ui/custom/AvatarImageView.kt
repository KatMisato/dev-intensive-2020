...
class AvatarImageView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        Log.e("AvatarImageView", "onDraw: drawable = $drawable, isAvatarMode = $isAvatarMode")
    ...
    override fun setImageDrawable(newDrawable: Drawable?) {
        Log.e("AvatarImageView", "setImageDrawable, isAvatarMode = $isAvatarMode, newDrawable = $newDrawable")
        super.setImageDrawable(newDrawable)
        if (isAvatarMode) prepareShader(width, height)
        Log.e("AvatarImageView", "setImageDrawable, isAvatarMode = $isAvatarMode, drawable = $drawable")
    }
    ...
    private fun drawAvatar(canvas: Canvas) {
        Log.e("AvatarImageView", "onDraw: avatarPaint = $avatarPaint")
